...
function istruzioniScena(n) {
	...
	case 5:
		...
		condizioni("trappola", per => {
			...
			rispondi("apro la porta|esco", "La porta è chiusa a chiave. Eppure, quando sei entrato, era aperta. L'agente immobiliare dovrebbe essere già qui.");
		});
		condizioni("no!la chiave@i");
			rispondi("apro la porta con la chiave", "Purtroppo, le chiavi di questa casa non sono con te... Dovrebbe averle l'agente immobiliare.");
